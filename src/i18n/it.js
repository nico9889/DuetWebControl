export default {
	...
	panel: {
		...
		jobControl: {
			...
			pauseJob: 'Sospendi',
			pausePrint: 'Sospendi stampa',
			pauseSimulation: 'Sospendi simulazione',
			resumeJob: 'Riprendi lavoro',
			resumePrint: 'Riprendi stampa',
			resumeSimulation: 'Riprendi simulazione',
			repeatJob: 'Avvia di nuovo',
			repeatPrint: 'Stampa di nuovo',
			repeatSimulation: 'Simula nuovamente',
			autoSleep: 'Abilita auto-spegnimento'
		},
		jobData: {
